...
#define STRING_CONFIG_H_AUTHOR "AcrOn" // Who made the changes.
 ...
 */
// #define S_CURVE_ACCELERATION    //Testing with and without it
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -56, -1.4, -1.325 }
